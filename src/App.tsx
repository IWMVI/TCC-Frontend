...
import {RotaProtegida} from '@/interfaces-graficas/componentes/auth/RotaProtegida';
import {Dashboard} from '@/interfaces-graficas/paginas/dashboard/Dashboard';
import {DetalheMetrica} from '@/interfaces-graficas/paginas/dashboard/DetalheMetrica';
...
import {Login} from '@/interfaces-graficas/paginas/auth/login/Login';
import {ConfirmarEmail} from '@/interfaces-graficas/paginas/auth/confirmar-email/ConfirmarEmail';
import {CriarConta} from '@/interfaces-graficas/paginas/auth/criar-conta/CriarConta';
import {RecuperarSenha} from '@/interfaces-graficas/paginas/auth/recuperar-senha/RecuperarSenha';
import {RedefinirSenha} from '@/interfaces-graficas/paginas/auth/redefinir-senha/RedefinirSenha';
import {Funcionarios} from '@/interfaces-graficas/paginas/funcionarios/Funcionarios';
import {ListarFuncionarios} from '@/interfaces-graficas/paginas/funcionarios/listar/ListarFuncionarios';
import {CriarFuncionario} from '@/interfaces-graficas/paginas/funcionarios/criar/CriarFuncionario';
import {EditarFuncionario} from '@/interfaces-graficas/paginas/funcionarios/editar/EditarFuncionario';
import {Financas} from '@/interfaces-graficas/paginas/financas/Financas';
          ...
          <Routes>
            ...
            <Route element={<RotaProtegida />}>
              <Route path="/" element={<Layout />}>
                ...
                <Route path="dashboard/:tipo" element={<DetalheMetrica />} />
                <Route path="financas" element={<Financas />} />
                <Route path="funcionarios" element={<Funcionarios />} />
                <Route path="funcionarios/listar" element={<ListarFuncionarios />} />
                <Route path="funcionarios/novo" element={<CriarFuncionario />} />
