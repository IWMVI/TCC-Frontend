import { BuscarClientePorIdUseCase } from '@/application/clientes/BuscarClientePorIdUseCase';
...
describe('BuscarClientePorIdUseCase', () => {
  ...
  beforeEach(() => {
    mockClienteRepositorio = {
      ...
      atualizar: jest.fn(),
      deletar: jest.fn(),
      listarExcluidos: jest.fn(),
      listarTodosExcluidos: jest.fn(),
      recuperarCliente: jest.fn(),
