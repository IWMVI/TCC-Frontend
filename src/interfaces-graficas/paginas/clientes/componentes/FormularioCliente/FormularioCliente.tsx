...
const MEDIDAS_PESSOA_JURIDICA: Medida[] = [
  { campo: 'cintura', label: 'Cintura' },
  { campo: 'manga', label: 'Manga' },
  { campo: 'alturaBusto', label: 'Altura Busto' },
  { campo: 'raioBusto', label: 'Raio Busto' },
...
export function FormularioCliente({
  ...
  function campo(
    ...
    return (
      <div className={`${styles.fc__campo} ${opts?.className ?? ''}`}>
      ...
      <form onSubmit={handleSubmit} className={styles.fc__form} noValidate>
        ...
        <div className={styles.fc__esquerda}>
          <div className={styles.fc__painel}>
            ...
            <div className={styles['fc__linha-tipo-cpf']}>
              <div className={styles.fc__campo}>
                <label className={styles.fc__label} htmlFor="tipoPessoa">
                  Tipo<span className={styles.fc__obrigatorio}>*</span>
                </label>
                <select
                  id="tipoPessoa"
                  name="tipoPessoa"
                  value={tipoPessoa}
                  className={`${styles.fc__select} ${styles['fc__select--tipo-pessoa']}`}
